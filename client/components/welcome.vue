<template>
  <div class="flex w-full justify-center items-center">
    ...
    >
      ...
      >
        <div
          class="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-70 w-full my-5 eth-card white-morphism"
        >
        ...
        <div
          class="flex sm:w-96 w-full p-5 flex-col justify-start items-center blue-glassmorphism"
        >
          <lazy-crypt-appInput
  ...
  methods: {
    ...
    async handleSubmit(e: any) {
      try {
        ...
        this.$store.commit('settings/setIsLoading')
        await this.sendTransaction(this.formData);
        this.formData = {
          addressTo: "",
          amount: "",
          keyword: "",
